...
<section class="relative min-h-[92vh] flex flex-col items-center justify-center text-center px-6 lg:px-margin-edge overflow-hidden pt-32 pb-24">
  ...
  <div class="max-w-4xl mx-auto flex flex-col items-center gap-8 relative z-10">
    ...
    <h1 class="font-display-xl text-[52px] sm:text-[76px] md:text-[96px] lg:text-[104px] text-on-surface font-light tracking-[-0.03em] leading-[0.93] max-w-4xl">
    ...
    <div class="flex flex-col sm:flex-row items-center gap-4 pt-2 w-full justify-center">
      ...
      <a href="#featured-work" class="tactile-press w-full sm:w-auto px-10 py-4 bg-surface-container/60 hover:bg-surface-container-high text-on-surface border border-white/10 rounded-full font-label-caps text-xs uppercase tracking-widest transition-all text-center">
        View Selected Work
      </a>
    </div>

    <!-- Proof Strip -->
    <div class="flex flex-wrap items-center justify-center gap-x-6 gap-y-3 pt-6 text-xs font-label-caps text-on-surface-variant/75">
      ...
      <div class="p-8 sm:p-12 rounded-3xl bg-surface-container/20 border border-white/[0.06] flex flex-col gap-6">
        ...
        <ul class="flex flex-col gap-4 font-body-md text-sm sm:text-base text-on-surface-variant/80 font-light">
          <li class="flex items-start gap-3">
            ...
            <span><strong>You need a $200 quick-fix or DIY site:</strong> We build handcrafted, bespoke software. Pre-built template services (like Squarespace or Wix) are a better fit for tight micro-budgets.</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="material-symbols-outlined text-on-surface-variant/40 text-[20px] shrink-0 mt-0.5">block</span>
