...
<body class="bg-background font-body-md text-on-background selection:bg-primary/30 relative" id="mainBody">
  ...
  <script src="/config.js?v=20260829_orbit_v5" defer></script>
  ${filename === 'index.html' ? '<script src="/js/hero-3d.js?v=20260829_orbit_v5" defer></script>' : ''}
  <script src="/js/app.js?v=20260829_orbit_v5" defer></script>
</body>
</html>
`;
